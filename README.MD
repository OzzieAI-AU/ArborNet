...
> The predecessor to Microsoft CNTK, but with a much smaller footprint, OzzieAI's ArborNet is the answer to Machine Learning where performance and resource efficiency are paramount.
